                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">All Multi Image Datatable</h4>
                              <br>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" style="border-collapse: collapse; border-spacing: 0px; width: 100%;" role="grid" aria-describedby="datatable_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        ...
                                                        aria-label="Position: activate to sort column ascending">About Multi Image
                                                    </th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1" style="width: 218.333px;"
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="even">
                                                    ...
                                                    <td> <img src="{{ asset($multiImage->multi_image) }}" style="width: 60px; height: 50px" alt="" srcset=""></td>
                                                    <td>

                                                        <a href=" {{ route('edit.multi.image', $multiImage->id) }}" class="btn btn-info sm" title="Edit Data" id="edit"><i class="fas fa-edit"> </i></a>
                                                        &nbsp;
                                                        &nbsp;
                                                        &nbsp;
