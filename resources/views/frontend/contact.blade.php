            ...
            <form action=" {{ route('contact.store') }} " method="post" class="contact__form">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        @if ($errors->has('name'))
                            <span
                                style="color: red; font-size:12px; margin-left:8px; margin-top:3px;">{{ $errors->first('name') }}</span>
                        @endif
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        @if ($errors->has('subject'))
                            <span
                                style="color: red; font-size:12px; margin-left:8px; margin-top:3px;">{{ $errors->first('subject') }}</span>
                        @endif
                    </div>
                    <div class="col-md-6">
                        ...
                        @if ($errors->has('phone'))
                            <span
                                style="color: red; font-size:12px; margin-left:8px; margin-top:3px;">{{ $errors->first('phone') }}</span>
                        @endif
                    </div>
                </div>
                ...
                @if ($errors->has('message'))
                    <span
                        style="color: red; font-size:12px; margin-left:8px; margin-top:3px;">{{ $errors->first('message') }}</span>
                @endif
